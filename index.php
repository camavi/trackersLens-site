...
<body>
  ...
  <header class="site-header" data-header>
    <nav class="navbar container" aria-label="Primary navigation">
      <a class="brand" href="#hero" aria-label="Trackers Lens home">
      ...
      <div class="nav-panel" id="site-menu" data-menu>
        ...
        <div class="nav-actions">
          ...
          <a class="btn btn-ghost" href="#"><?= icon('login') ?><?= t('nav.login') ?></a>
          <a class="btn btn-primary" href="#download"><?= icon('notify') ?><?= t('nav.download') ?></a>
        </div>
      </div>
    </nav>
  </header>
    ...
    <section class="hero section" id="hero">
      <div class="container hero-grid">
        <div class="hero-copy reveal">
          ...
          <div class="cta-row">
            <a class="btn btn-primary btn-large" href="#download"><?= icon('notify') ?><?= t('hero.ctaPrimary') ?></a>
...
tracker.start();</code></pre>
        ...
        <div class="resource-grid reveal">
          <a href="#" class="resource-card"><?= icon('book') ?><strong><?= t('developers.docs') ?></strong></a>
          <a href="#" class="resource-card"><?= icon('api') ?><strong><?= t('developers.api') ?></strong></a>
          <a href="#" class="resource-card"><?= icon('code') ?><strong><?= t('developers.examples') ?></strong></a>
          <a href="#" class="resource-card"><?= icon('groups') ?><strong><?= t('developers.community') ?></strong></a>
        </div>
      </div>
    </section>
    ...
    <section class="final-cta section" id="download">
      <div class="container reveal">
        ...
        <div class="cta-row center">
          <a class="btn btn-primary btn-large" href="#"><?= icon('notify') ?><?= t('cta.download') ?></a>
          <a class="btn btn-secondary btn-large" href="#demo"><?= icon('play') ?><?= t('cta.demo') ?></a>
        </div>
        <p><?= t('cta.note') ?></p>
      </div>
    </section>
